...
# check_apt-cacher.sh v.1.0
# (c) 2012 - Martin Seener
# License: OSL-3.0 (http://www.opensource.org/licenses/osl-3.0.php/)

# This little script checks apt-cacher`s process and default listen port, since it`s
# init script has no status function.
...
# Configuration START:
# Set apt-cacher`s process name and listen port
PROC="apt-cacher"
PORT="3142"
# Configuration END
